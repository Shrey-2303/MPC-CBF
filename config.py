...
moving_obs = [
    # Obstacle 1: Quadratic motion in x and y, including radius
    (0.01, 0.2, 0, 0.01, 0.6, 0.1, 0.1),  # ax*t^2 + bx*t + cx, ay*t^2 + by*t + cy, radius
    # Obstacle 2: Quadratic motion in x and y, including radius
    (-0.01, -0.15, 1.1, 0.01, 0.4, 0.05, 0.1)  # ax*t^2 + bx*t + cx, ay*t^2 + by*t + cy, radius
]
